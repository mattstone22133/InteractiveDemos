...
float RayTests::initForIntersectionTests()
{
	return std::numeric_limits<float>::infinity();
}

bool RayTests::triangleIntersect(const Ray& ray, const Triangle& tri, glm::vec3& intersectPnt, float& outT)
{
...
std::optional<glm::vec3> RayTests::rayPlaneIntersection(const Ray& ray, const glm::vec3& planeNormal_n, const glm::vec3& planePoint)
{
...
Ray ObjectPicker::generateRayFromCamera(const glm::vec2& screenResolution, const glm::vec2& clickPoint, const glm::vec3& cameraPos_w, const glm::vec3& cameraUp_n, const glm::vec3& cameraRight_n, const glm::vec3& cameraFront_n, float FOVy_deg, float aspectRatio)
{
...
void TriangleList::transform(const glm::mat4& model)
{
...
bool CameraRayCastData::validate() const
{
...
bool CameraRayCastData_Triangles::validate() const
{
