...
#define NAN_BREAK(value) 
	...
	inline glm::vec3 getDifferentVector(glm::vec3 vec)
	{
	...
	inline glm::quat getRotationBetween(const glm::vec3& from_n, const glm::vec3& to_n)
	{
	...
	inline glm::vec3 projectAontoB(const glm::vec3& a, const glm::vec3& b)
	{
		using namespace glm;
