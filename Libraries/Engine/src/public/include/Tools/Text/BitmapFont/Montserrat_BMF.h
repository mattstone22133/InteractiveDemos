...
//Font is based on google's royalty free front https://fonts.google.com/specimen/Montserrat
...
namespace Engine
{
	...
	public:
		...
		void _configureGlyphTable()
		{
			...
			//glyphTable['÷'] = new_sp<GlyphRenderer>(shader, fontTexture, glm::vec2(0.439f, 0.771f), 0.0146f, 0.0182f); //warning: illegal character encoding in character literal [-Winvalid-source-encoding]
			...
			//glyphTable['©'] = new_sp<GlyphRenderer>(shader, fontTexture, glm::vec2(0.549f, 0.771f), 0.0224f, 0.0218f); //warning: illegal character encoding in character literal [-Winvalid-source-encoding]
			...
			//make glyphs self-aware of the characters the glyph represents.
